import numpy as np
from .tools import euc_dist,norm_labels
from .cprint import cprint_out
...
if __name__=='__main__':
    ...
    from code.lda import lda
    data=scio.loadmat(os.path.join(os.path.dirname(__file__),'./test/lda_data_demo.mat'))
